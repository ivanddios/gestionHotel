...
{
    class DlgModificarCliente: Form
    {
        private Cliente cliente;

        public DlgModificarCliente(Cliente user)
        {
            this.cliente = user;
            this.Build();
        }
        ...
        void Build()
        {
            ...
            this.Text = "Modificar los datos del cliente " + this.cliente.Dni;
